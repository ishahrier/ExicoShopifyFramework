...
{
    public class ShowRemoteLogLevel : IXCommand
    {
        public string GetName()
        {
            return "show-remote-log-level";
        }

        public string GetDescription()
        {
            return "Show remote site's current (seri) log level.";
        }
                ...
                using (var scope = xc.WebHost.Services.CreateScope())
                {
                    ...
                    else
                    {
                        ...
                        try
                        {
                            ...
                            else xc.WriteError(this, "Server responded log level query was unsuccessful.");
